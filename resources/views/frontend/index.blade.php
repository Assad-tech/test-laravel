                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div id="bo_ho" class="we_box text_align_left">
                                                    <i><img src="frontend/images/we1.png" alt="#" /></i>
                                ...
                                <div class="container-fluid">
                                    <div class="carousel-caption we1_do">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div id="bo_ho" class="we_box text_align_left">
                                                    <i><img src="frontend/images/we2.png" alt="#" /></i>
                                            ...
                                            <div class="col-md-4">
                                                <div id="bo_ho" class="we_box text_align_left">
                                                    <i><img src="frontend/images/we3.png" alt="#" /></i>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div id="ho_nf" class="portfolio_main text_align_left">
                        <figure>
                            <img src="frontend/images/prot1.png" alt="#" />
                ...
                <div class="col-md-6">
                    <div id="ho_nf" class="portfolio_main text_align_left">
                        <figure>
                            <img src="frontend/images/prot2.png" alt="#" />
                            <div class="portfolio_text">
                                <div class="li_icon">
                                    <a href="Javascript:void(0)"><i class="fa fa-search" aria-hidden="true"></i></a>
                                    <a href="Javascript:void(0)"><i class="fa fa-link" aria-hidden="true"></i></a>
                ...
                <div class="col-md-6">
                    <div id="ho_nf" class="portfolio_main text_align_left">
                        <figure>
                            <img src="frontend/images/prot3.png" alt="#" />
                            <div class="portfolio_text">
                                <div class="li_icon">
                                    <a href="Javascript:void(0)"><i class="fa fa-search" aria-hidden="true"></i></a>
                                    <a href="Javascript:void(0)"><i class="fa fa-link" aria-hidden="true"></i></a>
                ...
                <div class="col-md-6">
                    <div id="ho_nf" class="portfolio_main text_align_left">
                        <figure>
                            <img src="frontend/images/prot4.png" alt="#" />
                            <div class="portfolio_text">
                                <div class="li_icon">
                                    <a href="Javascript:void(0)"><i class="fa fa-search" aria-hidden="true"></i></a>
                                    <a href="Javascript:void(0)"><i class="fa fa-link" aria-hidden="true"></i></a>
        ...
        <div class="container">
            <div class="row d_flex">
                ...
                <div class="col-lg-5 col-md-4">
                    <div class="chose_box">
                        <i><img src="frontend/images/chose1.png" alt="#" /></i>
                        <h3>Project Done </h3>
                        <strong>1000+</strong>
                ...
                <div class="col-lg-5 col-md-4">
                    <div class="chose_box">
                        <i><img src="frontend/images/chose2.png" alt="#" /></i>
                        <h3>Happy Clients </h3>
                        <strong>900+</strong>
                        <a class="read_more" href="Javascript:void(0)">Read More</a>
                    </div>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="chose_box">
                        <i><img src="frontend/images/chose3.png" alt="#" /></i>
                        <h3>Awards</h3>
                        <strong>100+</strong>
                        <a class="read_more" href="Javascript:void(0)">Read More</a>
                    </div>
                                ...
                                <div class="container">
                                    <div class="carousel-caption posi_in">
                                        <div class="clientsl_text">
                                            <i><img src="frontend/images/clint.jpg" alt="#" /></i>
                                            <h3>Deno <img src="frontend/images/icon.png" alt="#" /></h3>
                                            <p>It is a long established fact that a reader will be distracted by the
                                                readable content of a page when looking at its layout. The point of using
                                                Lorem IpsumIt is a long established fact that a reader will be distracted by
